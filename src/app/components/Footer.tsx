      ...
      <footer className={styles.footer}>
        <div className="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <nav className="flex gap-6 flex-wrap text-sm">
            ...
            <a href="/labelisation" className="hover:underline">Labelisation</a>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 py-4 text-center flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto px-4 gap-4">
          <div className="flex gap-4 justify-center">
            ...
            <a href="[https://facebook.com](https://facebook.com)" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            ...
            <a href="[https://instagram.com](https://instagram.com)" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <div className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Sofō. Tous droits réservés. | <a href="/mentions-legales" className="hover:underline">Mentions légales</a>
          </div>
        </div>
      </footer>
    );
